                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Employee</div>
                                            <?php
                                            $sql1 = "select count(id) as total_employee from tbl_employees";
                                            $result1 = mysqli_query(connection(), $sql1);
                                            $row1 = mysqli_fetch_assoc($result1);
                                            $sql2 = "select count(name) as total_department from tbl_departments";
                                            $result2 = mysqli_query(connection(), $sql2);
                                            $row2 = mysqli_fetch_assoc($result2);
                                            $sql3 = "select count(name) as total_country from tbl_countries";
                                            $result3 = mysqli_query(connection(), $sql3);
                                            $row3 = mysqli_fetch_assoc($result3);
                                            $sql4 = "select count(name) as total_region from tbl_regions";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $row2['total_department'] ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
