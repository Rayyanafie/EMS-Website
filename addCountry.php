...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $name = $_POST['name'];
    $region = $_POST['region'];
    $query = "INSERT INTO tbl_countries (id, name, region) VALUES ('$id', '$name', '$region')";
    ...
    if ($result) {
        ...
        <script> setTimeout(function() { window.location.href = 'addCountry.php'; }, 1000);</script>";
        exit;
    }
}
?>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <class="table-responsive">
                                <?php
                                $sql = "SELECT id, name FROM tbl_regions";
